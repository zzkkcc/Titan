...
public class Item {
	...
	//Except builders, no one can construct Item and set values
	...
	//Builder: use for constructing items
	//In order to set field all in builder
	//we want our parameters to be immutable
